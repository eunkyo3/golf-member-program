...
<script type="text/javascript">
    ...
    function cal_price() {
        ...
        if (cv.teacher_code.value === "100") {
            price = 100000;
        } else if (cv.teacher_code.value === "200") {
            price = 200000;
        } else if (cv.teacher_code.value === "300") {
            price = 300000;
        } else if (cv.teacher_code.value === "400") {
            price = 400000;
        }
        ...
        <form name="data" method="post" action="join_p.jsp" onsubmit="return checkValue()">
            <table class="table_line">
                ...
                <tr>
                    <th>강의명</th>
                    <td>
                        <select name="teacher_code" style="float: left;" onchange="cal_price()">
